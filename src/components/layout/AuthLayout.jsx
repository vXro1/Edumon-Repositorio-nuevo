    ...
    >
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div style={{
          ...
          background: "rgba(12,106,196,0.08)", filter: "blur(60px)",
        }} />
        <div style={{
          position: "absolute", bottom: "-80px", left: "-80px",
          width: 280, height: 280, borderRadius: "50%",
          background: "rgba(99,102,241,0.07)", filter: "blur(60px)",
        }} />
        <div style={{
          position: "absolute", top: "40%", left: "30%",
          width: 200, height: 200, borderRadius: "50%",
          background: "rgba(12,106,196,0.04)", filter: "blur(40px)",
        }} />
      </div>
      ...
      <div style={{ position: "relative", width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ marginBottom: 32, textAlign: "center" }}>
          <div style={{
            ...
            background: "white",
            boxShadow: "0 2px 12px rgba(12,106,196,0.12), 0 1px 3px rgba(0,0,0,0.06)",
          }}>
            <div style={{
